...
const Profile = (props) => {
    return (
        <div className={`${classes['post-info']}`}>
            ...
            <Posts title="My posts" textButton="Send" post={ props.state.posts } addPost={props.addPost} textDefault={props.state.newPostText} updateNewPostText={props.updateNewPostText} />
        </div>
    );
};
